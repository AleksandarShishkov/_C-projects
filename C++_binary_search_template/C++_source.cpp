		...
		/*
		 A C++ program which uses templates add value
		 to an user-defined type of an array.
 
		 It then sorts and searches the array for a
		 user-defined number, string or a char.
 
		 The templates are implemented in
		 a separate header file named tempaltes.h.
		 */
